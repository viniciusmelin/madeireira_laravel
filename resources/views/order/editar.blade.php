@extends('adminlte.page') @section('title', 'Editar Pedido') 
@section('content_header')
<h1>Editar Pedido</h1>
<ol class="breadcrumb">
        <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i>Iniciar</a></li>
		<li><a href="{{route('pedido.inicial')}}">Pedidos</a></li>
        <li class="active"><a href="{{route('pedido.cadastrar')}}">Editar</a></li>
</ol>
@stop 
@section('css')
				...
				<div class="row">
					<div class="col-lg-12 col-xs-12">
						<div class="col-lg-6 col-xs-6">
							<button type="button" disabled class="btn btn-info btn-md" data-toggle="modal" data-target="#modalClient" style="width: 100%">Selecionar Cliente
								<span class="glyphicon glyphicon-search"></span>
							</button>
						</div>
						<div class="col-lg-6 col-xs-6">
							<button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#modalSalesman" style="width: 100%">Selecionar Vendedor
								<span class="glyphicon glyphicon-search"></span>
							</button>
						</div>
					...
					<div class="row">
						<div class="col-lg-7">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="nameClient" data-id="{{$client->id}}" id="nameClient" placeholder="Nome do Cliente" value="{{$client->name}}" disabled>
							</div>
						</div>
						<div class="col-lg-5">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-lg-8">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="salesman_name" data-id="{{$salesman->id}}" id="salesman_name" placeholder="Nome do Vendedor" value="{{$salesman->name}}" disabled>
							</div>
						</div>
					</div>
				</div>
				<div class="box-footer">
					<button class="btn btn-success" style="width: 100%;" id="finalizar">Finalizar
	...
	<div class="col-lg-6">
		<div class="box box-primary">
			...
			<form id="formItem">
				...
				<div class="box-footer">
					<div class="col-lg-12">
						<button class="btn btn-success" style="width: 100%" id="btnAdicionar">Adicionar
				...
				<table class="table table-hover table-bordered" id="tableItems" style="width: 100%;">
					...
					@foreach($order_item as $item)
						<tr id="{{$item->product_id}}">
							...
							<td>{{$item->amount}}</td>
							<td>
								<button type="button" data-toggle="modal" data-target="#modalRemoveItem" title="Remover Item" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></button>
							</td>
						</tr>
					@endforeach
					</tbody>
