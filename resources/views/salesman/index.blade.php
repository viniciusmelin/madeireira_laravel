...
<ol class="breadcrumb">
        ...
        <li class="active"><a href="{{route('vendedor.cadastrar')}}">Vendedor</a></li>
</ol>
@stop @section('content')
<div class="row">
	<div class="col-xs-12">
		<p>
			<a class="btn btn-success btn-lg" href="{{route('vendedor.cadastrar')}}">Cadastrar</a>
		</p>
		<div class="box">
			<div class="box-header">
				<h3 class="box-title">Vendedores Cadastrados</h3>
			</div>
			<!-- /.box-header -->
